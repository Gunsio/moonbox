...
fn english(key: Text) -> &'static str {
    match key {
        ...
        Text::BuiltinKind => "builtin",
        Text::EnvironmentKind => "env",
        Text::ConfigKind => "config",
        Text::AgentKind => "agent",
        Text::Active => "active",
        Text::Stars => "stars",
        Text::Link => "link",
        Text::NotApplicable => "n/a",
        Text::NotConfigured => "not configured",
        Text::BuiltInReference => "built-in",
        Text::NoCompilerSkillsConfigured => "No compiler skills configured.",
        Text::CopyLinkCommand => "copy link/command",
        Text::Toggle => "Toggle",
        Text::Save => "Save",
        Text::Cancel => "Cancel",
        Text::Jump => "Jump",
...
fn zh_hans(key: Text) -> &'static str {
    match key {
        ...
        Text::BuiltinKind => "内置",
        Text::EnvironmentKind => "环境",
        Text::ConfigKind => "配置",
        Text::AgentKind => "Agent",
        Text::Active => "已启用",
        Text::Stars => "热度",
        Text::Link => "链接",
        Text::NotApplicable => "不适用",
        Text::NotConfigured => "未配置",
        Text::BuiltInReference => "内置",
        Text::NoCompilerSkillsConfigured => "未配置 compiler skill。",
        Text::CopyLinkCommand => "复制链接/命令",
        Text::Toggle => "切换",
        Text::Save => "保存",
        Text::Cancel => "取消",
        Text::Jump => "跳转",
