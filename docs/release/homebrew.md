...
2. Tag the accepted commit, for example `v0.1.3`.
...
class Moonbox < Formula
  ...
  bottle do
    root_url "https://github.com/Gunsio/moonbox/releases/download/v0.1.3"
    rebuild 1
  ...
  on_macos do
    on_arm do
      url "https://github.com/Gunsio/moonbox/releases/download/v0.1.3/moonbox-0.1.3-aarch64-apple-darwin.tar.gz"
      sha256 "<release-binary-sha256>"
    end

    on_intel do
      url "https://github.com/Gunsio/moonbox/releases/download/v0.1.3/moonbox-0.1.3-source.tar.gz"
  ...
  def install
    binary_root = if (buildpath/"bin/moonbox").exist?
      buildpath
    elsif (buildpath/"moonbox-0.1.3-aarch64-apple-darwin/bin/moonbox").exist?
      buildpath/"moonbox-0.1.3-aarch64-apple-darwin"
    end
