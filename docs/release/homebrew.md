...
2. Tag the accepted commit, for example `v0.1.5-beta.51`.
3. Stage local release artifacts:

```bash
scripts/release/stage-artifacts.sh --version 0.1.5-beta.51 --tag v0.1.5-beta.51
```
...
class Moonbox < Formula
  ...
  bottle do
    root_url "https://github.com/Gunsio/moonbox/releases/download/v0.1.5-beta.51"
    rebuild 1
