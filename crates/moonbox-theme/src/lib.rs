...
mod tests {
    ...
    fn luoshen_theme_labels_are_bilingual() {
        ...
        assert_eq!(ThemeId::LuoshenSwan.ascii_icon(), "~>");
        assert_eq!(ThemeId::LuoshenDragon.ascii_icon(), "S~");
        assert_eq!(ThemeId::LuoshenChrysanthemum.ascii_icon(), "*o");
        assert_eq!(ThemeId::LuoshenPine.ascii_icon(), "/\\");
        assert_eq!(
